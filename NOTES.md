...
2.  Находим последний созданный в репозитории тэг и делаем такой же, но с префиксом `v`, то есть если в репозитории `boutique/carts` есть тэг `0.4.8`, то мы создаем тэг `v0.4.8`
